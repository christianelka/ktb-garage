...
if($ukuran < 1044070){      
    if ($filename == FALSE){
        mysqli_query($hai, "UPDATE mobil SET nama_mobil='$nama_mobil', kelas='$kelas', harga='$harga' WHERE id_mobil='$id_mobil'");
        header("location:index.php?notif1=true");
    } else {
        $xx = $rand.'_'.$filename;
        move_uploaded_file($_FILES['foto']['tmp_name'], '../../assets/img/Armada/'.$rand.'_'.$filename);
        mysqli_query($hai, "UPDATE mobil SET nama_mobil='$nama_mobil', kelas='$kelas', harga='$harga', foto='$xx' WHERE id_mobil='$id_mobil'");
        header("location:index.php?notif1=true");
    }
}else{
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <?php 
                              $result = mysqli_query($hai, "SELECT * FROM mobil WHERE id_mobil='$_GET[id_mobil]'");
                            ...
                            <div class="card-body row g-3">
                                <div class="col-md-12">
                                  ...
                                  <input type="text" class="form-control" id="nama_mobil" name="nama_mobil" value="<?php echo $row['nama_mobil']?>"> 
                                </div>
                                <div class="col-md-12">
