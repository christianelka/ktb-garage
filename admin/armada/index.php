                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <?php }?>
                                Disini kita bisa melihat semua daftar mobil, dan disini kita juga bisa menambahkan atau menghapus mobil.
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <button class="btn btn-primary" name="" style="float:right;">
                                    <a href="add.php" class="text-white" style="text-decoration: none;"><i class="fa fa-trash-o fa-plus-circle"></i> Tambah Mobil</a>
                                </button>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 20%;"><?php echo $row['nama_mobil']?></td>
                                            <td style="width: 18%;">
                                            <?php if ($row['kelas'] == 1){
                                                echo "Premium";
                                              } else if ($row['kelas'] == 2){
                                            ...
                                            <td style="width: 18%;"><?php echo $row['harga']?></td>
                                            <td align="center" style="width: 30%;"><img src="<?php echo '../../assets/img/Armada/'.$row['foto']?>" style="width: 50%"></td>
                                            <td>
                                              <button class="btn btn-success" name="">
                                                  <a href="edit.php?id_mobil=<?php echo $row['id_mobil']?>" class="text-white"><i class="fa fa-trash-o fa-edit"></i></a>
                                              </button>
                                              <button class="btn btn-danger" name="">
                                                  <a href="delete.php?id_mobil=<?php echo $row['id_mobil']?>" class="text-white"><i class="fa fa-trash-o fa-trash"></i></a>
                                              </button>
                                            </td>
                                        </tr>
                                    <?php }}?>
