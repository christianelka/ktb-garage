...
if(!in_array($ext,$ekstensi) ) {
    ...
    if($ukuran < 1044070){      
        ...
        mysqli_query($hai, "INSERT INTO driver VALUES(NULL,'$nama_driver','$level','$deskripsi','$xx', 1)");
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body row g-3">
                                <div class="col-md-12">
                                  ...
                                  <input type="text" class="form-control" id="nama_mobil" name="nama_driver" placeholder="Nama Driver"> 
                                </div>
                                <div class="col-md-12">
