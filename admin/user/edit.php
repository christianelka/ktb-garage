...
if (isset($_POST['update'])){
  ...
  // echo $alamat;
  $sql = "UPDATE user SET email='$email', password='$password', nama_user='$nama', no_hp='$no_hp', alamat='$alamat' WHERE id_user='$id_user'";
  mysqli_query($hai, $sql);
  if ($sql){
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Daftarkan user melalui halaman ini.
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php 
                                    $edit = "SELECT * FROM user WHERE id_user=$_GET[id_user]";
                                    $result = mysqli_query($hai, $edit);
                                    ...
                                    <form method="POST" action="edit.php" class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          <input type="text" class="form-control" id="password" name="password" name="nama" value="<?php echo $row['password']?>"> 
                                        </div>
                                        <div class="col-md-12">
                                          <label for="" class="form-label">Nomer Hp</label>
                                          <input type="number" class="form-control" id="no_hp" name="no_hp" name="nama" value="<?php echo $row['no_hp']?>"> 
                                        </div>
                                        <div class="col-md-12">
                                          <label for="" class="form-label">Alamat</label>
                                          <input type="text" class="form-control" id="alamat" name="alamat" name="nama" value="<?php echo $row['alamat']?>"> 
                                        </div>
