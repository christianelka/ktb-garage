                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <?php }?>
                                Disini kita bisa melihat semua data member, dan disini kita juga bisa menambahkan atau menghapus member.
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <button class="btn btn-primary" name="" style="float:right;">
                                    <a href="add.php" class="text-white" style="text-decoration: none;"><i class="fa fa-trash-o fa-plus-circle"></i> Tambah User</a>
                                </button>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 20%;"><?php echo $row['nama_user']?></td>
                                            <td style="width: 18%;"><?php echo $row['email']?></td>
                                            <td style="width: 18%;"><?php echo $row['password']?></td>
                                            <td style="width: 12%;"><?php echo $row['no_hp']?></td>
                                            <td style="width: 20%;"><?php echo $row['alamat']?></td>
                                            <td>
                                              <button class="btn btn-success" name="">
                                                  <a href="edit.php?id_user=<?php echo $row['id_user']?>" class="text-white"><i class="fa fa-trash-o fa-edit"></i></a>
                                              </button>
                                              <button class="btn btn-danger" name="">
                                                  <a href="delete.php?id_user=<?php echo $row['id_user']?>" class="text-white"><i class="fa fa-trash-o fa-trash"></i></a>
                                              </button>
                                            </td>
                                        </tr>
                                    <?php }}?>
